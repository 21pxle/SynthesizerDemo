public class Pitch {
    public static final int Bs_MINUS_ONE = 0;
    public static final int C_MINUS_ONE = 0;

    public static final int Cs_MINUS_ONE = 1;
    public static final int Db_MINUS_ONE = 1;

    public static final int D_MINUS_ONE = 2;

    public static final int Ds_MINUS_ONE = 3;
    public static final int Eb_MINUS_ONE = 3;

    public static final int E_MINUS_ONE = 4;

    public static final int Es_MINUS_ONE = 5;
    public static final int F_MINUS_ONE = 5;

    public static final int Fs_MINUS_ONE = 6;
    public static final int Gb_MINUS_ONE = 6;

    public static final int G_MINUS_ONE = 7;

    public static final int Gs_MINUS_ONE = 8;
    public static final int Ab_MINUS_ONE = 8;

    public static final int A_MINUS_ONE = 9;

    public static final int As_MINUS_ONE = 10;
    public static final int Bb_MINUS_ONE = 10;

    public static final int B_MINUS_ONE = 11;
    public static final int Cb_MINUS_ONE = 11;

    public static final int Bs0 = 12;
    public static final int C0 = 12;

    public static final int Cs0 = 13;
    public static final int Db0 = 13;

    public static final int D0 = 14;

    public static final int Ds0 = 15;
    public static final int Eb0 = 15;
    ...
    public static final int Gb1 = 30;

    public static final int G1 = 31;

    public static final int Gs1 = 32;
    public static final int Ab1 = 32;

    public static final int A1 = 33;

    public static final int As1 = 34;
    public static final int Bb1 = 34;

    public static final int B1 = 35;
    public static final int Cb1 = 35;

    public static final int Bs2 = 36;
    ...
    public static final int Cb2 = 47;


    public static final int Bs3 = 48;
    ...
    public static final int Cb3 = 59;


    public static final int Bs4 = 60;
    public static final int C4 = 60;

    public static final int Cs4 = 61;
    public static final int Db4 = 61;

    public static final int D4 = 62;

    public static final int Ds4 = 63;
    public static final int Eb4 = 63;
    ...
    public static final int Gb9 = 126;

    public static final int G9 = 127;

    public static final int Gs9 = 128;
    public static final int Ab9 = 128;

    public static final int A9 = 9;

    public static final int As9 = 10;
    public static final int Bb9 = 10;

    public static final int B9 = 11;
    public static final int Cb9 = 11;


    public static final int Bs10 = 0;
    public static final int C10 = 0;

    public static final int Cs10 = 1;
    public static final int Db10 = 1;

    public static final int D10 = 2;

    public static final int Ds10 = 3;
    public static final int Eb10 = 3;

    public static final int E10 = 4;

    public static final int Es10 = 5;
    public static final int F10 = 5;

    public static final int Fs10 = 6;
    public static final int Gb10 = 6;

    public static final int G10 = 7;
}
